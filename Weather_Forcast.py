...
root.iconbitmap('weather.ico') #Use your own .ico Otherwise Error here 
...
def search():
    ...
    api_key = '1e1e2416de8e2028bb0abc94851ce43c' #USE YOUR OWN API KEY
    ...
    'main': {'temp': 298.88, 'feels_like': 302.56, 'temp_min': 298.15, 'temp_max':
    299.82, 'pressure': 1010, 'humidity': 85}, 'visibility': 10000,
    'wind': {'speed': 2.24, 'deg': 151, 'gust': 4.47}, 'rain': {'1h': 0.25}, 'clouds':
    {'all': 82}, 'dt': 1596407271, 'sys': {'type': 3, 'id': 2005683,
    'country': 'US', 'sunrise': 1596361095, 'sunset': 1596412955}, 'timezone': -14400,
